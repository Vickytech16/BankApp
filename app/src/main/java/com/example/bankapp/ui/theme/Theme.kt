...
val LightColorScheme = Theme.brownLightTheme
val DarkColorScheme = Theme.goldenDarkTheme
...
object Theme {
    val brownLightTheme = lightColorScheme(
    ...
    val goldenDarkTheme = darkColorScheme(
